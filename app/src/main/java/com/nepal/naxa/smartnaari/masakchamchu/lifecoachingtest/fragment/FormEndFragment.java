...
public class FormEndFragment extends Fragment implements LifeCoachingTestActivity.onFragmentVisibleListener {
    ...
    private void notifyEvaluateForm() {
        ...
        tvDisplayResult.setText (((LifeCoachingTestActivity)getActivity()).displayResult());
    }
