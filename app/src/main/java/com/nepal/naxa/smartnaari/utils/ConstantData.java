...
public class ConstantData {
    ...
    public final static String[] voilenceType = {"Select Type", "Rape", "Sexual assault", "Physical assault", "Forced Marriage", "Denial of Resources, Opportunities or Services",
            "Psychological/Emotional Abuse", "Domestic Abuse and Violence", "Child Sexual Abuse", "Early or Child Marriage", "Internet/Cyber Violence", "Sexual Trafficking",
