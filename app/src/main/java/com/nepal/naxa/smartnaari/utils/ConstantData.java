...
public class ConstantData {
    ...
    public final static String[] noConsentType = {"  ", "Rape", "Sexual assault", "Sexual Harassment ",  "Physical assault", "Denial of Resources, Opportunities or Services", "Psychological / Emotional Abuse"};
